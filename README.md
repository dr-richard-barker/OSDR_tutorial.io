...
**How to use the** [**OSDR data repository**](https://osdr.nasa.gov/bio/repo/)
...
**Selecting sample(s) data for export**
...
**Selecting assay data for export**
...
**Exporting tables to csv, txt, or .xls**
...
**The File(s) tab provides raw and processed data**
...
**Launching the single-study data visualization**
...
**Replicate variability pair plots**
...
**Table of resulting gene expression data**
...
**Ontology databases and statistical methods used for analysis.**
...
**Selecting “processed studies” to find higher-order data.**
...
**Selecting a study or group of studies for visualization**
...
**Studies Metadata Menu as a Table**
...
**Key elements of the EDA application:**
...
**Select 1 or more Rodent Research (RR) missions.**
...
**Scroll down and download tables of radiation metadata**
...
**Comparison of the environmental measurements on the ISS and Ground.**
...
**Tables of environmental meta-data with download option.**
...
**Instruction on how to create a NASA Guest account to access the BDME**
...
**“Raw data can be uploaded later.”**
...
**Entering the study description using publication (Option 1)**
...
**Guided Submission adding assays (Option 2)**
...
**Selecting periods for closer inspection**
...
**Geospatial orthographic projection**
...
**RadLab sensor color definitions**
...
**Constructing Your Request URL: Examples in Action**
...
**Crafting Your Search Query: Understanding the Syntax**
...
**Building Your Search URL: Examples in Action**
...
**Understanding POST and GET Filter Field Options**
...
**Step 1: Accessing Metadata and Data**
...
**Prerequisites: Equipping Yourself AWS CLI data access.**
...
**Navigating the OSDR Data Landscape**
...
**Automating Your Workflow: Scripting with the AWS CLI**
